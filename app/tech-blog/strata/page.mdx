export const metadata = {
  ...
  description:
    "a time-series database built from scratch in c++. custom bit-level compression, write-ahead log, memtable, and lsm-tree compaction.",
  alternates: {
    canonical: '/tech-blog/strata',
  },
};
